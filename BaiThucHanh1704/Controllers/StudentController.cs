...
namespace BaiThucHanh1704.Controllers
{
    public class StudentController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("StudentID,StudentName,FacultyID,Addreess")] Student student)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(string id, [Bind("StudentID,StudentName,FacultyID,Addreess")] Student student)
        {
